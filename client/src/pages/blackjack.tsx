  ...
  return (
    <div className="casino-felt min-h-screen p-4 flex items-center justify-center">
      <div className="w-full max-w-6xl flex gap-8">
          ...
          <div className="game-table rounded-3xl p-8 mb-6">
            ...
            <div className="text-center mb-8">
              <div className="score-display inline-block px-6 py-3 rounded-xl">
                <div className="text-xl font-semibold text-white" data-testid="game-status">
        ...
        {/* Win/Loss Statistics - Right Side */}
        <div className="w-80 flex flex-col justify-center">
          <div className="sticky top-8">
            <h3 className="text-2xl font-bold text-primary text-center mb-6">📊 Statistics</h3>
            <GameStats 
              wins={gameState.wins}
